...
namespace Piton.Banking.Migrations
{
    ...
    [Migration("20240808105256_sequence_addded")]
    partial class sequence_addded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Piton.Banking.Entities.Accounts.Account", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<string>("AccountNumber")
                        ...
                        .HasDefaultValueSql("SELECT NEXT VALUE FOR AccountNumberSequence");
            ...
            modelBuilder.Entity("Piton.Banking.Entities.CreditCards.CreditCard", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BankingCreditCards");
                });

            modelBuilder.Entity("Piton.Banking.Entities.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BankingCustomers");
                });

            modelBuilder.Entity("Piton.Banking.Entities.DebitCards.DebitCard", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BankingDebitCards");
                });

            modelBuilder.Entity("Piton.Banking.Entities.Transactions.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Piton.Banking.Entities.Accounts.Account", b =>
                {
                    b.HasOne("Piton.Banking.Entities.Customers.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Piton.Banking.Entities.DebitCards.DebitCard", b =>
                {
                    b.HasOne("Piton.Banking.Entities.Accounts.Account", "Account")
                        .WithMany()
            ...
            modelBuilder.Entity("Piton.Banking.Entities.Transactions.Transaction", b =>
                {
                    b.HasOne("Piton.Banking.Entities.CreditCards.CreditCard", "CreditCard")
                        .WithMany()
                        .HasForeignKey("CreditCardId");

                    b.HasOne("Piton.Banking.Entities.DebitCards.DebitCard", "DebitCard")
                        .WithMany()
