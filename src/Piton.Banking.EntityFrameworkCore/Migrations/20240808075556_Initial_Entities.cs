    ...
    public partial class Initial_Entities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankingCustomers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BankingAccounts_BankingCustomers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "BankingCustomers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "BankingCreditCards",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankingCreditCards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BankingCreditCards_BankingCustomers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "BankingCustomers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankingDebitCards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BankingDebitCards_BankingAccounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "BankingAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BankingDebitCards_BankingCustomers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "BankingCustomers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BankingTransactions_BankingCreditCards_CreditCardId",
                        column: x => x.CreditCardId,
                        principalTable: "BankingCreditCards",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BankingTransactions_BankingDebitCards_DebitCardId",
                        column: x => x.DebitCardId,
                        principalTable: "BankingDebitCards",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankingAccounts_AccountNumber",
                table: "BankingAccounts",
                column: "AccountNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BankingAccounts_CustomerId",
                table: "BankingAccounts",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_BankingCreditCards_CustomerId",
                table: "BankingCreditCards",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_BankingDebitCards_AccountId",
                table: "BankingDebitCards",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_BankingDebitCards_CustomerId",
                table: "BankingDebitCards",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_BankingTransactions_CreditCardId",
                table: "BankingTransactions",
                column: "CreditCardId");

            migrationBuilder.CreateIndex(
                name: "IX_BankingTransactions_DebitCardId",
                table: "BankingTransactions",
                column: "DebitCardId");
